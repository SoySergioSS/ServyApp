...
class OrdersViewModel @Inject constructor(
    ...
    private fun loadOrders() {
        viewModelScope.launch {
            ...
            //Obtener el restaurantId del SessionManager a través de UserRepository
            val restaurantId = userRepository.getSelectedRestaurantId().first()
            ...
            pedidoRepository.getUserOrders(restaurantId, currentUser.uid)
